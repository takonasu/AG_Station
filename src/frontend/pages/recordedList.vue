<template>
  <section class="section">
    <div class="content">
      <h1 class="title">ジョブ実行済み一覧</h1>
      <p>録画の実行はされていますが，稀に失敗することがあります．</p>
      <div
        ...
        "
      >
        <div v-if="program.recorded == true" class="card" style="margin: 10px">
    ...
    <div v-if="modalInfo.view" class="modal is-active">
      ...
      <div class="modal-card">
        ...
        <footer class="modal-card-foot">
          <button class="button" @click="deleteRecord(modalInfo.id)">
            履歴を消去
          </button>
